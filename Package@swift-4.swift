...
var dependencies: [Package.Dependency] = [
    .package(url: "https://github.com/Kitura/Kitura.git", .upToNextMinor(from: "2.6.0")),
    ...
    .package(url: "https://github.com/Kitura/Kitura-OpenAPI.git", from: "1.1.0"),
    .package(url: "https://github.com/Kitura/Kitura-StencilTemplateEngine.git", from: "1.9.0"),
    .package(url: "https://github.com/Kitura/Kitura-Markdown.git", from: "1.0.0"),
    .package(url: "https://github.com/Kitura/Kitura-CredentialsHTTP.git", from: "2.1.0"),
    ...
    .package(url: "https://github.com/Kitura/Swift-JWT", from: "3.0.0"),
    .package(url: "https://github.com/Kitura/Swift-Kuery-ORM.git", .upToNextMinor(from: "0.5.0")),
]
...
// dependencies.append(.package(url: "https://github.com/Kitura/Swift-Kuery-PostgreSQL.git", from: "1.2.0"))
...
if ProcessInfo.processInfo.environment["KITURA_NIO"] != nil {
    dependencies.append(.package(url: "https://github.com/Kitura/Kitura-WebSocket-NIO.git", from: "1.0.0"))
} else {
